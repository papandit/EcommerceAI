...
// class PdfService {
//   Future<void> printCustomersPdf(OrderModel data) async {
...
//     row.cells[0].value = data.formattedDeliveryDate;
...
//     print("::row ${row}");
//     print("::llll ${data.deliveryDate}");
//     print("::llll ${data.deliveryDate}");
//     print("::llll ${data.deliveryDate}");
//     print("::llll ${data.totalAmount}");
