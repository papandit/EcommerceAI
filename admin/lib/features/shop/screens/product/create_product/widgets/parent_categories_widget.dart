...
class ProductParentCategories extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Fetch categories only once (not on every rebuild).
        ...
        child: TRoundedContainer(
          child: Column(
            ...
            children: [
                  ...
                  : DropdownButtonFormField<String>(
                      ...
                      onChanged: (newValue) {
                        createProductController.subcategoryname.value =
                            newValue!;
                        createProductController.subcategoryid.value = newValue;
                      },
              ...
              //         prefixIcon: Icon(Iconsax.bezier)),
              //     onChanged: (newValue) {
              //       createProductController.subcategoryname = newValue!;
              //     },
              //     items: createProductController.sub_category_datass
