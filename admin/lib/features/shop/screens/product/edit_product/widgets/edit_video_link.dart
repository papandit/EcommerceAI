...
class EditVideoLink extends StatefulWidget {
  const EditVideoLink({
    super.key,
  });

  @override
  State<EditVideoLink> createState() => _EditVideoLinkState();
}

class _EditVideoLinkState extends State<EditVideoLink> {
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              controller: controller.linkTextField,
