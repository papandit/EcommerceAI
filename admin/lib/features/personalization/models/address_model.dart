...
class AddressModel {
  ...
  /// Safe builder from a REST API JSON map (Node/MongoDB backend).
  ...
  factory AddressModel.fromMap(Map<String, dynamic> data) {
    return AddressModel(
        ...
        dateTime: data['DateTime'].runtimeType == String
            ? Timestamp.fromMillisecondsSinceEpoch(
                    DateTime.parse(data['DateTime']).millisecondsSinceEpoch)
                .toDate()
